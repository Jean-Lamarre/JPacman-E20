...
public class CollisionInteractionMap implements CollisionMap {
    ...
    private List<Class<? extends Unit>> getInheritance(Class<? extends Unit> clazz) {
        ...
        while (found.size() > index) {
            ...
            FindAssignableSuperClass(current, found);
            FindAssignableClassInterface(current, found);
    ...
    private void FindAssignableSuperClass(Class<?> current, List<Class<? extends Unit>> found) {
    ...
    private void FindAssignableClassInterface(Class<?> current, List<Class<? extends Unit>> found) {
